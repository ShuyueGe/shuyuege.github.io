...
export function ProjectShowcase() {
  ...
  return <section className="selected-work page-shell" id="projects" aria-labelledby="work-title">
    <div className="selected-work__heading"><h2 id="work-title">Selected work</h2></div>
    <div className="selected-work__features">
      <article className="work-feature work-feature--bookthing">
        <Link className="work-feature__link" to="/projects/ngo-website-redesign">
          <div className="work-feature__copy">
            <p className="work-feature__category">Information architecture · Solo academic concept</p>
            <h3>BookThing <span aria-hidden="true">↗</span></h3>
          </div>
          ...
          <p className="work-feature__description">Giving free books, opening dates, and donation choices a clearer place.</p>
        </Link>
      </article>
      <article className="work-feature work-feature--patsy">
        <Link className="work-feature__link" to="/projects/restaurant-website-redesign">
          <div className="work-feature__copy">
            <p className="work-feature__category">Research &amp; mobile UX · Team academic concept</p>
            <h3>Patsy’s <span aria-hidden="true">↗</span></h3>
          </div>
          ...
          <p className="work-feature__description">Following a dining task from menu browsing to a proposed pickup path.</p>
        </Link>
      </article>
    </div>
    <div className="work-index">
      ...
      {otherProjects.map(project => <Link className="work-index__entry" key={project.slug} to={`/projects/${project.slug}`}>
        <h3>{project.title}</h3><span>{project.subtitle}</span><span aria-hidden="true">↗</span>
      </Link>)}
    </div>
  </section>;
}
